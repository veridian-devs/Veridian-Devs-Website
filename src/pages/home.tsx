...
export default function Home() {
    return (
        <div className='h-full w-full py-14 sm:py-30 md:py-20 px-6 md:px-28 flex flex-col items-center justify-center space-y-8'>
            ...
            <button className='py-2 px-4 border border-white rounded-md bg-[var(--primary)] text-[var(--secondary)] font-semibold  hover:bg-transparent hover:backdrop-blur-md hover:text-[var(--primary)] pointer-events-auto transition-all duration-300'>Request a Callback</button>
        </div>
    )
}
